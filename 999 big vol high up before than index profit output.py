...
data.to_csv('/Users/chunyanwang/Christine documents/projects/different daily strategies/999 big vol high up before index with new indicators.csv')
...
output.to_csv('/Users/chunyanwang/Christine documents/projects/different daily strategies/999 big vol high up before index output profit.csv')
...
plt.show()
plt.savefig('/Users/chunyanwang/Christine documents/projects/different daily strategies/999 big vol high up before index.csv' \
             + '.png')
plt.close('all')
#plt.legend(loc='best')